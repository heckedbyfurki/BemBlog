<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="YoneticiGuncelle.aspx.cs" Inherits="BemBlog.Admin.YoneticiGuncelle" %>
            ...
            <table class="table">
                ...
                <tr>
                    <td>
                        ...
                        <asp:LinkButton ID="lbtn_add" runat="server" OnClick="lbtn_add_Click" Text="Yönetici Güncelle" CssClass="formButton"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
